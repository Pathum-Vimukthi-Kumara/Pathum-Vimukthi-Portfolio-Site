    ...
    <div id="project-section" className="min-h-screen bg-purple-gradient pt-20 py-8 sm:py-12 lg:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20 animate-fadeInUp">
          ...
          {/* View All button moved below carousel for right-hand placement */}
        </div>
        ...
        {/* Right-aligned 'View All Projects' button below carousel */}
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-end mt-6 pr-4 sm:pr-6 lg:pr-8">
            <Link to="/projects" className="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-purple-secondary text-white font-semibold hover:opacity-90 transition">
              View All Projects
