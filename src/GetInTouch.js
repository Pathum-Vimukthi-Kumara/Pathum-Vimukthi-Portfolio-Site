    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div className="text-center mb-16 animate-fadeInUp">
        ...
        <p className="text-purple-light/70 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg">
          I'm always looking for new challenges and interesting projects. Whether you have a specific idea or just want to chat about tech, I’m only a message away.
        </p>
      </div>
      ...
      <div className="flex flex-nowrap overflow-x-auto pb-10 gap-6 snap-x hide-scrollbar md:grid md:grid-cols-2 max-w-5xl mx-auto -mx-4 px-4 sm:mx-0 sm:px-0">
        ...
        >
          <div className="absolute top-0 right-0 p-8 text-6xl opacity-10 group-hover:scale-110 group-hover:rotate-12 transition-transform">📧</div>
